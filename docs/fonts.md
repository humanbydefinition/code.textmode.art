...
:::info Next steps
-> Learn the basics of drawing in [Fundamentals](/docs/fundamentals).

-> See how fonts affect exports in [Exporting](/docs/exporting).

-> Try fonts quickly in the [Web Editor](https://editor.textmode.art).
:::