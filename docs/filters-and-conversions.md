...
description: Compatibility index for the former combined filters and conversions page.
---
...
[Filters](/docs/filters) are fragment-shader post-processing passes applied to rendered ASCII textures: either an individual layer's ASCII texture or the final composited output.
