...
[textmode.js](../index.md) / TextmodeTexture

# Class: TextmodeTexture

Represents an external texture source for textmode rendering via [Textmodifier.createTexture](Textmodifier.md#createtexture).
...
| ------ | ------ | ------ |
| `colorOrGray` | `string` \| `number` \| [`TextmodeColor`](TextmodeColor.md) | A grayscale value (0-255), hex string ('#RGB', '#RRGGBB', '#RRGGBBAA'), or TextmodeColor instance |
...
Resources created via [Textmodifier.loadImage](Textmodifier.md#loadimage), [Textmodifier.loadVideo](Textmodifier.md#loadvideo),
and [Textmodifier.createTexture](Textmodifier.md#createtexture) are automatically disposed when the
[Textmodifier](Textmodifier.md) instance is destroyed, but you can call this manually to free memory earlier.
