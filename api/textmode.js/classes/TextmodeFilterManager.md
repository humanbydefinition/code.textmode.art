...
[textmode.js](../index.md) / TextmodeFilterManager
...
| `shader` | `string` \| [`TextmodeShader`](TextmodeShader.md) | Pre-compiled GLShader, fragment shader source string, or path to a .frag/.glsl file |
