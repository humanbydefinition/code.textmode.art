...
editLink: true
title: set
description: Set this vector's components.
category: Methods
api: true
...
[textmode.js](../../../index.md) / [TextmodeVector](../../TextmodeVector.md) / set
...
| ------ | ------ | ------ |
| `value` | \| readonly `number`[] \| \| [`TextmodeVector`](../../TextmodeVector.md) \| \{ `x`: `number`; `y`: `number`; `z?`: `number`; \} | Vector-like value or component array to copy. |
