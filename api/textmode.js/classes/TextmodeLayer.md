...
[textmode.js](../index.md) / TextmodeLayer
...
like you would with the base layer's [Textmodifier.draw](Textmodifier.md#draw) method.
...
can be accessed via [Textmodifier.layers](Textmodifier.md#layers) as `t.layers.base`.
...
```ts
get asciiFramebuffer(): TextmodeFramebuffer | undefined;
```
...
[`TextmodeFramebuffer`](TextmodeFramebuffer.md) \| `undefined`
...
```ts
get drawFramebuffer(): TextmodeFramebuffer | undefined;
```
...
Load a font into this layer from a URL/path or from an existing [TextmodeFont](TextmodeFont.md).

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `fontSource` | `string` \| [`TextmodeFont`](TextmodeFont.md) | The URL/path to the font file, or an existing TextmodeFont to fork from. |
...
Load a tileset into this layer from load options or from an existing [TextmodeTileset](TextmodeTileset.md).

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `tilesetSource` | \| [`TextmodeTilesetOptions`](../interfaces/TextmodeTilesetOptions.md) \| [`TextmodeTileset`](TextmodeTileset.md) | Tileset load options or an existing TextmodeTileset to fork from. |
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `camera` | [`TextmodeCamera`](TextmodeCamera.md) | Camera instance to apply. |
