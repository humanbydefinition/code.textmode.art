...
Manages the font used for rendering characters via [layering.TextmodeLayer.loadFont](TextmodeLayer.md#loadfont).

This class coordinates font loading, character extraction, texture atlas creation,
and provides character information.

Each [layering.TextmodeLayer](TextmodeLayer.md) has its own instance of this class to allow for
