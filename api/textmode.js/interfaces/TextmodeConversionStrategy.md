...
[textmode.js](../index.md) / TextmodeConversionStrategy
...
| ------ | ------ | ------ | ------ |
| <a id="property-id"></a> `id` | `readonly` | `string` | Unique identifier for this conversion strategy. This ID is used to select the strategy via [TextmodeSource.conversionMode](../classes/TextmodeSource.md#conversionmode). |
