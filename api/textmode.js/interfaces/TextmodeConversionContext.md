...
[textmode.js](../index.md) / TextmodeConversionContext
...
| <a id="property-source"></a> `source` | [`TextmodeSource`](../classes/TextmodeSource.md) | The source asset (image, video, etc.) being converted. Provides access to the source texture and dimensions. |
