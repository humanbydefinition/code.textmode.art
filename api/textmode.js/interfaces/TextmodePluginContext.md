...
[textmode.js](../index.md) / TextmodePluginContext
...
| <a id="property-font"></a> `font` | \| [`TextmodeFont`](../classes/TextmodeFont.md) \| [`TextmodeTileset`](../classes/TextmodeTileset.md) | The active glyph source used by the Textmodifier instance (from base layer). |
...
| <a id="property-layermanager"></a> `layerManager` | [`TextmodeLayerManager`](../classes/TextmodeLayerManager.md) | The layer manager for accessing and managing all layers. |
